...
public class AppTest {
    ...
    public void testAutoProxyApi() {
        ...
        PersonService personService = cxt.getBean( "personServiceProxy", PersonService.class );
        Person qiaogh = personService.get( "1" );
        assertIsQiaogh( qiaogh );
    ...
    @Test
    public void testExcludeAutoProxyApi() {
        PersonService personService = cxt.getBean( PersonService.SERVICEKEY, PersonService.class );
        Person qiaogh = personService.get( "1" );
        assertIsQiaogh( qiaogh );
        
        Assert.assertFalse( personService instanceof Advised );
    }
