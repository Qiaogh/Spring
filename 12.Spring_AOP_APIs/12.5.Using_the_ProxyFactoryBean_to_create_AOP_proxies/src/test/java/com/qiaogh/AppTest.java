...
public class AppTest {
    ...
    @Test
    public void testWildcardAdvice() {
        Assert.assertFalse( PersonServiceBeforeGetAdvice.INVOKED );
        Assert.assertFalse( PersonServiceAfterGetReturningAdvice.INVOKED );
        ...
        Assert.assertTrue( PersonServiceAfterGetReturningAdvice.INVOKED );
    }
