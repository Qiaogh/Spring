...
public class SystemArchitecture {
     ...
     */
    @Pointcut( "within(com.qiaogh.action..*)" )
     ...
     */
    @Pointcut( "within(com.qiaogh.service..*)" )
     ...
     */
    @Pointcut( "within(com.qiaogh.dao..*)" )
     ...
     */
    @Pointcut( "execution(* com.qiaogh..service.*.*(..))" )
     ...
     */
    @Pointcut( "execution(* com.qiaogh.dao.*.*(..))" )
