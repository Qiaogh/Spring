...
public class AppConfig {
    ...
    private static final String PROC_QUERY_PERSON = "query_persons";
    ...
    @Bean
    public SimpleJdbcCallOperations queryJdbcCallOperations( DataSource dataSource ) {
        return new SimpleJdbcCall( dataSource ).withProcedureName( PROC_QUERY_PERSON )
                .returningResultSet( "persons", BeanPropertyRowMapper.newInstance( Person.class ) );
    }
}
