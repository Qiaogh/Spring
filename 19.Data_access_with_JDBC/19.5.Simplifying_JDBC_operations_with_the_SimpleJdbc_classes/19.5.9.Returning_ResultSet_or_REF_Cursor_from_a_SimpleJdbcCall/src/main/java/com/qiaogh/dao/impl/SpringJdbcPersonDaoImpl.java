...
public class SpringJdbcPersonDaoImpl implements PersonDao {
    ...
    private SimpleJdbcCallOperations queryJdbcCall;
    ...
    public List<Person> query() {
        Map<String, Object> result = queryJdbcCall.execute( Collections.emptyMap() );
        return (List<Person>) result.get( "persons" );
    }
    ...
    public SimpleJdbcCallOperations getQueryJdbcCall() {
        return queryJdbcCall;
    }

    @Resource( name = "queryJdbcCallOperations" )
    public void setQueryJdbcCall( SimpleJdbcCallOperations queryJdbcCall ) {
        this.queryJdbcCall = queryJdbcCall;
    }
}
